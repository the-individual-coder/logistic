...
export const Project = () => {
    ...
    const registerProject = async (e: any) => {
        try {
            setIsLoading(true);
            e.preventDefault
             await axios.post(`${hostServer}/registerProject`, addDataForm);
            fetchAssets();
    ...
    const updateProject = async (e:any, id:number) => {
        try {
            e.preventDefault()
            setIsLoading(true);
            await axios.post(`${hostServer}/updateProject`, {
                ...updateDataForm, projectID: id
            });
            fetchAssets()
    ...
    const removeProject = async (id: number) => {
        try {
            setIsLoading(true);
            await axios.delete(`${hostServer}/removeProject/${id}`);
    ...
    useEffect(()=>{console.log(addDataForm)},[addDataForm])
    useEffect(()=>{console.log(updateDataForm)},[updateDataForm])
    ...
    return (
                                        ...
                                        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 dark:text-neutral-400">
                                                    Create projects, edit and delete.
                                                </p>
                                            </div>
                                            <div>
                                                                            ...
                                                                            <input
                                                                                onChange={(e) => {
                                                                                    setAddDataForm({
                                                                                        ...
                                                                                        startDate: addDataForm.startDate,
                                                                                        endDate: addDataForm.endDate,
                                                    ...
                                                    <div
                                                        ...
                                                        >
                                                            <div className={` dialog-container dialog-${data.id} ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto`}>
                                                                <div className="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                                                                    <form onSubmit={(e) => { updateProject(e, data.id) }}>
                                                                        <div className="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                                                                            <h3
                                                                                id="hs-focus-management-modal-label"
                                                                                className="font-bold text-gray-800 dark:text-white"
                                                                        ...
                                                                        <div className="p-4 overflow-y-auto">
                                                                            ...
                                                                            <input
                                                                                onChange={(e) => {
                                                                                    setUpdateDataForm({
                                                                                        ...
                                                                                        startDate: updateDataForm.startDate,
                                                                                        endDate:updateDataForm.endDate,
                                                                            ...
                                                                            <input
                                                                                value={formatDateForInput(updateDataForm.startDate)}
                                                                                onChange={(e) => {
                                                                                    setUpdateDataForm({
                                                                                        name: updateDataForm.name,
                                                                                        description: updateDataForm.startDate,
                                                                                        startDate: e.target.value,
                                                                                        endDate:updateDataForm.endDate,
                                                                                        status: updateDataForm.status,
                                                                                    })
                                                                            ...
                                                                            <input
                                                                                value={formatDateForInput(updateDataForm.endDate)}
                                                                                onChange={(e) => {
                                                                                    setUpdateDataForm({
                                                                                        name: updateDataForm.name,
                                                                                        description: updateDataForm.description,
        ...
        //                  <button onClick={() => updateProject({ ...asset, status: 'Updated Status' })}>Update</button>
        //                  <button onClick={() => removeProject(asset.id)}>Delete</button>
        //              </li>
        //          ))}
        //      </ul>
